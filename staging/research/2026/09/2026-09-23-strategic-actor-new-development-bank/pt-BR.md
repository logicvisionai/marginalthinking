...
```chart
type: line
title: Membros do New Development Bank
unit: países membros
2015 | 5
2021 | 7
2023 | 8
...
A série é derivada das datas oficiais de adesão. Mede participação institucional, não concentração de voto, volume de crédito ou alinhamento político.

## A arquitetura de capital e votos separa o Banco da coordenação informal do BRICS
...
Em 2025, o NDB aprovou **19 projetos no valor de US$ 3,171 bilhões**. No fim do ano, seu portfólio continha 115 projetos com US$ 35,593 bilhões de financiamento aprovado. [NDB — Annual Report 2025](https://www.ndb.int/annual-report/2025/overview/)

Esses números medem aprovações, não infraestrutura concluída ou valores efetivamente desembolsados. Um banco de desenvolvimento se torna economicamente consequente pela cadeia completa entre mobilização de capital, desembolso, construção, operação e pagamento.
...
## Financiamento em moeda local é uma capacidade, não apenas uma distinção de marca
...
```mindmap
Canais estruturais do NDB
- Base de capital
  - subscrições dos membros
  - capital exigível
  - captação de mercado
- Financiamento do desenvolvimento
  - empréstimos soberanos
  - empréstimos não soberanos
  - garantias
  - equity
...
- Restrições
  ...
  - risco-país
  - profundidade dos mercados locais
  - desembolso e implementação
```
...
## O NDB é adicional apenas se fornecer financiamento que não seja facilmente substituído em termos equivalentes

Mutuários também podem recorrer a bancos domésticos, mercados de títulos, financiadores bilaterais, Grupo Banco Mundial, bancos regionais e investidores privados. A relevância do NDB depende de fornecer escala, prazo, moeda, expertise ou velocidade que ampliem o conjunto viável, em vez de simplesmente substituir outro credor.

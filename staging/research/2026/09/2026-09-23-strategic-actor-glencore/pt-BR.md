# Glencore: quando propriedade produtiva e comercialização de commodities ocupam a mesma cadeia

**Programa:** Global System & Power  
**Código:** MT-SA-2026-09-23-GLENCORE  
...
A Glencore informou produção própria em 2025 de **851,6 mil toneladas de cobre, 969,4 mil toneladas de zinco e 71,9 mil toneladas de níquel**. Também produziu 36,1 mil toneladas de cobalto, 32,5 milhões de toneladas de carvão metalúrgico e 98,0 milhões de toneladas de carvão energético. [Glencore — Full Year 2025 Production Report](https://www.glencore.com/media-and-insights/news/full-year-2025-production-report)

```chart
type: bar
title: Produção própria selecionada de metais da Glencore em 2025
unit: mil toneladas
Cobre | 851.6
Zinco | 969.4
Níquel | 71.9
...
As barras comparam produção física na mesma unidade, não valor econômico ou importância estratégica. Elas mostram a escala em que decisões operacionais de ativos controlados entram na oferta física.
...
## O cobalto mostra como regras soberanas podem limitar capacidade corporativa

O relatório de 2025 associou explicitamente decisões operacionais e menor produção de cobalto às restrições de exportação da República Democrática do Congo. A orientação de produção para 2026 não forneceu meta de cobalto porque um sistema de cotas se aplica às exportações do país até pelo menos o fim de 2027; material acima da cota pode permanecer armazenado no país e os planos operacionais precisam se adaptar. [Glencore — Full Year 2025 Production Report](https://www.glencore.com/media-and-insights/news/full-year-2025-production-report)

É um caso útil de limite. Propriedade de minas cria capacidade produtiva, mas regras soberanas determinam se parte da produção pode alcançar mercados externos. A capacidade corporativa opera dentro de restrições legais e políticas.

## O portfólio é heterogêneo; substituibilidade deve ser avaliada por commodity

Cobre, zinco, níquel, cobalto e carvão possuem demanda, processamento, ciclos de projeto e concentrações geográficas diferentes. Não é defensável atribuir um único grau de substituibilidade ao grupo inteiro.

```mindmap
Canais estruturais da Glencore
- Produção
  - cobre
  - zinco
  - níquel
...
- Processamento e infraestrutura
  - determinadas fundições e plantas
  - logística
- Restrições externas
  - teor e geologia
  - licenças e tributação
  - cotas de exportação
...
Uma mina de alto teor e longa vida pode ser difícil de substituir no curto prazo mesmo quando existem muitos fornecedores globais. Por outro lado, uma operação grande mas de custo elevado pode perder relevância se nova oferta concorrente entrar no mercado. A unidade de análise deve permanecer o ativo ou a cadeia da commodity, e não a receita consolidada.

## A produção não é fixa: geologia e sequenciamento importam

A produção de cobre caiu 11% em 2025, de 951,6 mil toneladas para 851,6 mil toneladas, com a empresa atribuindo grande parte da queda a teor, recuperação e sequenciamento de minas. A produção de zinco subiu 7% para 969,4 mil toneladas. Isso mostra por que capacidade não pode ser inferida apenas de reservas: oferta efetiva depende de qualidade do minério, desempenho de plantas, sequenciamento e investimento.

No primeiro semestre de 2026, a orientação de cobre permaneceu em 810–870 mil toneladas, enquanto alterações de ativos — incluindo a venda da mina Kidd — afetaram a base operacional. [Glencore — Half-Year Production Report 2026](https://www.glencore.com/media-and-insights/news/half-year-production-report-2026)
...
- [Glencore — Half-Year Production Report 2026](https://www.glencore.com/media-and-insights/news/half-year-production-report-2026)
- [Glencore — Reports and results](https://www.glencore.com/investors/reports-results)

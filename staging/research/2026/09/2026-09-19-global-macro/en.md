...
| Nasdaq | +0.4% Friday | tech-led resilience | Long-duration equities are absorbing high yields for now |
...
```chart
type: bar
title: Weekly fund flows reveal regional divergence
unit: USD billion
...
```map
title: Gulf energy transmission remains geographically asymmetric
Saudi Arabia | East-West pipeline and Red Sea access provide partial redundancy | Repair pace and realized throughput determine substitution
Oman | Sohar ship-to-ship operations provide an alternative loading point | Scale and persistence remain uncertain
Strait of Hormuz | Traffic remains exposed to conflict and security risk | Insurance, freight and physical passage affect landed energy costs
Europe | Some Saudi October cargoes were reportedly disrupted | Refiners can seek alternative barrels, potentially at different costs
Asia | Large Gulf import exposure remains | Lower crude helps import bills, but route risk persists
```
...
The STOXX 600 fell **1.1%** on Friday. Autos were particularly weak after Volkswagen cut its outlook, citing large one-off charges, China weakness and restructuring costs. This is a useful distinction: the European decline was not only a macro-duration trade. Company-specific earnings revisions and industrial exposure are reinforcing the pressure from energy and interest rates.
...
```flow
Partial Saudi export workaround and diplomatic pressure → lower immediate crude-supply premium → less near-term inflation pressure → some relief for equities and inflation hedges

Fed/BOJ tightening + long sovereign yields near multi-year highs → expensive refinancing and higher discount rates → pressure on leveraged borrowers and long-duration valuations

Persistent conflict risk + uncertain Gulf logistics → demand for protection and route redundancy → support for gold, insurance premia and alternative energy logistics
```
...
Primary and first-line references used for this edition include the Bank of Japan policy decision (18 Sep. 2026), U.S. Treasury market data, Brazil Central Bank/Copom decision, and Reuters market, energy, precious-metals and fund-flow reporting dated 18 Sep. 2026. Key URLs: https://www.reuters.com/world/china/global-markets-wrapup-1-2026-09-18/ ; https://www.reuters.com/business/energy/oil-prices-fall-1-hopes-limited-supply-disruptions-2026-09-18/ ; https://www.reuters.com/world/asia-pacific/boj-raises-interest-rates-31-year-high-widely-expected-move-2026-09-18/ ; https://www.reuters.com/world/china/global-markets-flows-graphic-pix-2026-09-18/ ; https://www.reuters.com/business/gold-extends-gains-scale-one-week-high-crude-prices-ease-2026-09-18/ ; https://www.reuters.com/world/americas/brazil-central-bank-cuts-rates-fifth-straight-meeting-2026-09-16/ . Market levels refer to the latest available Friday close or late-Friday observation because the report is prepared after the September 18 session.
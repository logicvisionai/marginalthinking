...
function institutionalEntries(locale){
  const defs=locale==='pt-BR'?[['home','Marginal Thinking','Pesquisa sobre economia, política e sociedade.','/index.html'],['archive','Arquivo de pesquisas','Todos os relatórios e análises publicados.','/reports.html'],['method','Método','Método, evidências, incerteza e padrões analíticos.','/methodology.html'],['about','Sobre','Identidade institucional, escopo e princípios editoriais.','/about.html'],['coverage','Cobertura de pesquisa','Cobertura temática, geográfica e por idioma do acervo.','/research/coverage/']]:[['home','Marginal Thinking','Research on economics, politics and society.','/index.html'],['archive','Research archive','All published reports and analysis.','/reports.html'],['method','Method','Method, evidence, uncertainty and analytical standards.','/methodology.html'],['about','About','Institutional identity, scope and editorial principles.','/about.html'],['coverage','Research coverage','Thematic, geographic and language coverage of the corpus.','/research/coverage/']];

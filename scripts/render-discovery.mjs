...
function institutionalEntries(locale){
  ...
  defs.push(locale==='pt-BR'?['dependencies','Rede Global de Dependências','Explore mecanismos, relações, histórico e pesquisas ligadas à rede de dependências.','/dependencies/']:['dependencies','Global Dependency Network','Explore mechanisms, relationships, history and research connected to the dependency network.','/dependencies/']);

...
const replacements=[
  ...
  ['O petróleo representa a camada física; o Treasury acima de 5%, a camada financeira; defesa, autonomia tecnológica e rotas estratégicas, a camada política.','O petróleo elevado encarece produção e transporte; o Treasury acima de 5% aumenta o custo de financiamento; e maiores gastos com defesa, autonomia tecnológica e proteção de rotas exigem recursos adicionais.'],
  ...
  ['reservatório de riqueza comparável aos grandes ativos físicos','estoque de riqueza de grande importância econômica'],
  ['Por isso, os números deste relatório são **mapas de poder por camada**, não parcelas aditivas de uma mesma pizza.','Por isso, os números deste relatório representam dimensões diferentes da distribuição de riqueza e capacidade econômica; eles não podem ser somados como parcelas independentes de um mesmo total.'],
  ...
  ['convertendo escala física em poder de cadeia','usando escala industrial para aumentar sua influência sobre cadeias de suprimento'],
  ['### Índia e Sudeste Asiático — **ganho de opção**','### Índia e Sudeste Asiático — **maior capacidade de atrair novos projetos**'],
  ...
  ['Claims são ativos de um agente e passivos/obrigações de outro','Esses ativos bancários representam direitos de um agente e obrigações de outro'],
  ...
  ['Buffer recorde','Reservas em nível recorde'],
  ['Fluxos asiáticos seguem divergentes.','Os fluxos financeiros na Ásia seguem direções diferentes.'],
  ['por custodians e centros financeiros','por instituições de custódia e centros financeiros'],
  ['1 ano/forward','1 ano e projeções'],
  ['disciplina de capex','disciplina de investimento'],
  ...
  ['setores de duration → caixa/ativos de menor duration via reprecificação','ações e ativos mais sensíveis aos juros → caixa e ativos menos sensíveis aos juros, em resposta à reprecificação'],
  ...
  ['benefício de valuation','benefício de valorização'],
  ['risco em valuation','risco de precificação'],
  ['Valuation migra parcialmente de software para infraestrutura.','Parte do valor atribuído pelo mercado pode se deslocar de empresas de software para empresas de infraestrutura.'],
  ['valuation/FX','preço e câmbio'],
  ['valuation americano','precificação dos ativos americanos'],
  ['commodity beta uniforme','movimento uniforme das commodities'],
  ...
  ['principal polo incremental de refino','principal centro de expansão da capacidade de refino'],

...
function optimizeHeadAssets(html){
  ...
  out=out.replace(/<link\s+href="(https:\/\/fonts\.googleapis\.com\/css2\?[^"]+)"\s+rel="stylesheet">/gi,(all,href)=>`<link rel="stylesheet" href="${href}" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="${href}"></noscript>`);
  if(out.includes('data-research-visual=')){
    if(!out.includes('id="home-critical-css"')&&!out.includes('href="/assets/css/research-visuals.css"'))out=out.replace('</head>','<link rel="stylesheet" href="/assets/css/research-visuals.css"></head>');

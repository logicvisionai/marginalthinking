...
export function makeLayout(ctx){
  ...
  function nav(active='research',alternates={}){
    ...
    const research=group(t.nav.research,['research','research-intelligence','coverage','energy','research-hubs','data'],[

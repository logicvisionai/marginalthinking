...
```flow
Nile irrigation → concentrated agricultural settlement → taxable surplus → administrative capacity → public works and political centralization
Strategic location → transit and trade rents → foreign interest and investment → infrastructure → exposure to external geopolitical shocks
```
...
```chart
type: bar
title: Selected real GDP growth around the 2026 adjustment
unit: annual %
2024/25 | 4.4
FY2025/26 IMF | 4.6
FY2026/27 IMF | 4.4
...
Egypt's population more than doubled in roughly four decades while habitable and cultivated space remained concentrated around the Nile and delta. This raises the required pace of school construction, housing, transport, water investment and job creation.
...
```chart
type: line
title: Egypt's population scale
...
```flow
Exchange-rate pressure → depreciation → imported food and energy inflation → tighter monetary conditions → expensive private credit
State borrowing and public projects → domestic financing demand → higher rates/crowding out → weaker private investment → slower productivity growth
```
...
```map
title: Egypt's structural economic geography
Nile Valley and Delta → population, agriculture and cities → food and labour markets → water and land constraint
Suez Canal → Europe–Asia shipping → foreign-currency receipts → exposure to Red Sea security and global trade cycles
Mediterranean gas infrastructure → domestic power and exports → external balance → energy-price and field-performance risk
Cairo/Alexandria industrial-services core → national market → jobs and finance → congestion and housing pressure
```
...
```chart
type: bar
title: Headline inflation around the current reform cycle
unit: %
June 2026 | 14.3

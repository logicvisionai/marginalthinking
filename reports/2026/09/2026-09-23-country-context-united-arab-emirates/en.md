# United Arab Emirates: federation, hydrocarbon rents and the construction of a global logistics-finance platform
...
```flow
Abu Dhabi oil rents → federal fiscal capacity and sovereign wealth → infrastructure and stability → lower platform risk
Dubai trade/logistics strategy → ports + aviation + free zones → multinational presence → network effects → non-oil revenue
```
...
```chart
type: bar
title: Recent and projected real GDP growth
unit: annual %
2023 | 3.6
2024 | 4
2025 IMF | 4.8
...
```flow
Hydrocarbon revenue → sovereign funds/public investment → logistics, real estate and technology → diversified fee/rent income → lower oil dependence over time
Regional conflict → shipping/insurance disruption → tourism and trade slowdown + oil-routing constraints → confidence shock → cyclical slowdown
```
...
```map
title: UAE structural geography
Abu Dhabi → oil/gas and sovereign capital → federal finance and global assets → macro buffers
Dubai/Jebel Ali → port, airport, free zones and finance → regional corporate hub → network effects
Strait of Hormuz approaches → hydrocarbon and shipping routes → external trade → geopolitical exposure
Northern emirates → manufacturing, tourism and commuter links → integration with Dubai/Abu Dhabi → regional development
```
...
```chart
type: bar
title: IMF 2026 inflation and growth outlook
unit: %
Real GDP growth | 3.1
